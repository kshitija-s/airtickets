...
<center><img src="logo.png" width="10%"/>
    <form name="login_form" method="post" action="authenticate.php" target="http://localhost/user/home.html ">
        <div class="table-responsive" style="width: 60%">
            <table class="table table-striped">
                ...
                <tr>
                    <td colspan="2"><center><a href="signup.php">Register</a></center> </td>
                </tr>
            </table>
        </div>
    </form>
